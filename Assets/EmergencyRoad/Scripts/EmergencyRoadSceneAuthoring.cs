...
namespace EmergencyRoad
{
    ...
    [RequireComponent(typeof(EmergencyRoadGameplaySettingsComponent))]
    public sealed class EmergencyRoadSceneAuthoring : MonoBehaviour
    {
        ...
        [Header("GAMEPLAY SETTINGS - EDIT DIRECTLY ON THIS SCENE OBJECT")]
        [SerializeField] private EmergencyRoadGameplaySettingsComponent gameplaySettingsComponent;
        [SerializeField, HideInInspector] private EmergencyRoadGameplaySettings legacyGameplaySettings;
