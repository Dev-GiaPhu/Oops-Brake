...
namespace EmergencyRoad
{
    ...
    public static class EmergencyRoadSceneUIFactory
    {
        public static EmergencyRoadMenuView CreateMenu(Transform parent)
        {
            ...
            view.price = EmergencyRoadUI.Label(garage, "ĐÃ MỞ", 28, EmergencyRoadUI.Yellow, TextAnchor.MiddleCenter, new(.08f,.51f), new(.92f,.63f), Vector2.zero, Vector2.zero);
        ...
        public static EmergencyRoadGameView CreateGame(Transform parent)
        {
            ...
            view.gameOverPanel = Modal(canvas.transform,"HẾT LƯỢT!",out view.gameOverScore);
